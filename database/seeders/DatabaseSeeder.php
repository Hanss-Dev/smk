    ...
    public function run(): void
    {
        ...
        DB::table('admin_users')->insertOrIgnore([
            [
                'id' => 1,
                'username' => 'admin',
                'password' => '$2y$10$ChnV.ZQ1ukGiEaS0.i6LQuHSVGxXVfy9bU9Fdty1n2jFP9HUBFzXC',
                'created_at' => now(),
                'updated_at' => now(),
            ]
        ]);
        ...
        // Seed highlights
        DB::table('highlights')->insertOrIgnore([
            [
                'id' => 3,
                ...
                'image' => '1769685434-slider1.jpeg',
                'is_active' => 1,
                'created_at' => '2026-01-23 09:15:59',
                'updated_at' => '2026-01-23 09:15:59',
            ]
        ]);
