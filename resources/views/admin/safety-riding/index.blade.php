      ...
      <div class="card">
        <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
          ...
          <div class="d-flex align-items-center flex-wrap" style="gap: 10px;">
            <form action="{{ route('admin.safety-riding.index') }}" method="GET" class="form-inline my-1">
            ...
            <a href="{{ route('admin.safety-riding.create') }}" class="btn btn-primary btn-sm my-1">
