    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
          <h3 class="card-title mb-0">Daftar Bagian — Safety Riding</h3>
          <div class="d-flex align-items-center" style="gap: 8px;">
            ...
            <a href="{{ route('admin.safety-riding.create') }}" class="btn btn-primary btn-sm">
              ...
              @foreach($sections as $sIdx => $section)
                <div class="card card-outline card-primary mb-3 section-card"
                  ...
                  <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div>
                      <a href="{{ route('admin.safety-riding.edit', ['sIdx' => $sIdx]) }}"
                         class="btn btn-warning btn-sm" title="Edit bagian ini">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form action="{{ route('admin.pagesection.deleteSection', ['key' => 'safety-riding', 'sIdx' => $sIdx]) }}"
                        ...
                        <tbody>
                          @forelse($section['elemen'] ?? [] as $eIdx => $el)
                            <tr>
                              ...
                              <td>
                                @if($el['type'] === 'image')
                                  <img class="preview-image" src="{{ asset('uploads/safety-riding/' . $el['value']) }}"
                              ...
                              <td class="text-center">
                                <form action="{{ route('admin.pagesection.deleteElement', ['key' => 'safety-riding', 'sIdx' => $sIdx, 'eIdx' => $eIdx]) }}"
                                      method="POST" style="display:inline;"
