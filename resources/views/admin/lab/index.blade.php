...
<div class="content-wrapper" data-guide-page="lab-index">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Lab Komputer</h1></div>
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
          <h3 class="card-title my-1">Daftar Bagian — Lab Komputer</h3>
          <div class="d-flex align-items-center flex-wrap" style="gap: 10px;">
            <form action="{{ route('admin.lab.index') }}" method="GET" data-guide="index-search"  class="form-inline my-1">
              <div class="input-group input-group-sm" style="width: 250px;">
                ...
                <div class="input-group-append">
                  ...
                  @if(request('search'))
                    <a href="{{ route('admin.lab.index') }}" class="btn btn-default" title="Reset Pencarian">
            ...
            <a href="{{ route('admin.lab.create') }}" data-guide="index-add-btn" class="btn btn-primary btn-sm my-1">
        ...
        <div class="card-body table-responsive">
          ...
          <form action="{{ route('admin.pagesection.bulkDelete', 'lab-komputer') }}" method="POST" class="bulk-delete-form">
            @csrf
            @method('DELETE')
            <div class="mb-2 d-flex justify-content-between align-items-center">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input bulk-select-all" id="selectAllLab">
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <td class="text-center" @if($sIdx === 0) data-guide="index-row-actions" @endif>
                      <a href="{{ route('admin.lab.edit', ['sIdx' => $sIdx]) }}" class="btn btn-warning btn-sm" title="Edit">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form action="{{ route('admin.pagesection.deleteSection', ['key' => 'lab-komputer', 'sIdx' => $sIdx]) }}" method="POST" style="display:inline;" class="form-delete" data-confirm-message="Hapus bagian ini beserta semua elemennya?">
                        @csrf
                        @method('DELETE')
