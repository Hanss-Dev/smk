...
@section('content')
<div class="content-wrapper" data-guide-page="highlight-create">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Tambah Highlight</h1></div>
        <div class="col-sm-6">
        ...
        <div class="col-md-10">
          <div class="card card-primary shadow-sm">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-star mr-1"></i> Form Tambah Highlight</h3>
            </div>

            <form action="{{ route('admin.highlight.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
