            ...
            <form action="{{ route('admin.highlight.update', $highlight->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" data-guide="form-input" class="form-control" value="{{ old('title', $highlight->title) }}" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  @if($highlight->image)
                    <div class="mb-2">
                      <img src="{{ asset('storage/highlight/' . $highlight->image) }}" class="preview-image img-thumbnail" style="max-height:150px;">
                    </div>
                  @endif
