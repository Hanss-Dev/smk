...
@section('content')
<div class="content-wrapper" data-guide-page="podcast-index">
      ...
      <div class="card">
        <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
          ...
          <div class="d-flex align-items-center flex-wrap" style="gap: 10px;">
            <form action="{{ route('admin.podcast.index') }}" method="GET" data-guide="index-search" class="form-inline my-1">
            ...
            <a href="{{ route('admin.podcast.create') }}" data-guide="index-add-btn" class="btn btn-primary btn-sm my-1">
