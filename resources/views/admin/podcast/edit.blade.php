...
@section('title', 'Edit Bagian Podcast')

@section('content')
<div class="content-wrapper" data-guide-page="podcast-edit">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Edit Bagian Podcast</h1></div>
        <div class="col-sm-6">
      ...
      <div class="row justify-content-center">
        <div class="col-md-10">
          <div class="card card-warning shadow-sm">
            ...
            <form action="{{ route('admin.podcast.update') }}" method="POST" enctype="multipart/form-data">
              @csrf @method('PUT')
              ...
              <div class="card-body">
                ...
                {{-- Elemen Builder (pre-filled dengan data existing) --}}
                <div class="form-group">
