...
@section('content')
<div class="content-wrapper" data-guide-page="alumni-edit">
            ...
            <form action="{{ route('admin.alumni.update', $alumni->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="NamaSiswa" data-guide="form-input" class="form-control" value="{{ old('title', $alumni->nama_alumni) }}" required>
                </div>
