...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Edit Popup</h1></div>
        <div class="col-sm-6">
        ...
        <div class="col-md-10">
          <div class="card card-warning shadow-sm">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-edit mr-1"></i> Form Edit Popup</h3>
            </div>
            ...
            <form action="{{ route('admin.popup.update', $popup->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  @if($popup->image)
                    <div class="mb-2">
                      <img src="{{ asset('storage/popup/' . $popup->image) }}" class="preview-image img-thumbnail" style="max-height:150px; cursor:pointer;">
                    </div>
                  @endif
                ...
                <div class="form-group">
                  ...
                  <textarea name="content" rows="6" class="form-control" required>{{ old('content', $popup->content) }}</textarea>
                </div>

                <div class="form-group">
                  <label>Status</label>
                  <select name="is_active" class="form-control">
                    <option value="1" {{ old('is_active', $popup->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Aktif (Tampilkan)</option>
                    <option value="0" {{ old('is_active', $popup->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Nonaktif (Sembunyikan)</option>
                  </select>
                </div>
