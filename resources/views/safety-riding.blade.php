...
<section class="breadcrumbs">
  <div class="breadcrumbs-bg" style="background-image:url('{{ asset('assets/img/TKR/TKR.jpg') }}')">
    <div class="overlayy"></div>
    <div class="container">
      <h1 class="page-title">Safety Riding</h1>
      <div class="breadcrumbs-nav">
        <a href="{{ route('home') }}">SMK Mitra Industri MM2100</a>
        <span>&gt;</span>
        <span class="current">Safety Riding</span>
      </div>
    </div>
  </div>
</section>
